...
Проект National Transport Hackathon 2026, трек 1 (данные Минтранса и Яндекса).
...
будет, и это не небрежность, а условие: датасет выдан участникам хакатона и не
...
Датасет выдан **на условиях организаторов**: не распространять вне команды, не публиковать,
...
покрыты и здесь не лежат: датасет организаторов выдан на условиях хакатона и не
